...
import { ArrowLeft, Brain, TrendingUp, AlertCircle, CheckCircle, Target, Users, Sparkles, Calendar } from 'lucide-react';
...
const BehaviorAnalysisPage: React.FC = () => {
  ...
  const { user, habits, checkIns, screenTime } = useUser();
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600">Insights from your habits, check-ins, and activity</p>
          </div>
        </motion.div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-green-50 p-4 rounded-xl">
                <div className="text-3xl font-bold text-green-600">{user?.streak || 0}</div>
              ...
              <div className="bg-pink-50 p-4 rounded-xl">
                <div className="text-3xl font-bold text-pink-600">{user?.microTasksCompletedToday || 0}</div>
